...
namespace GameName.Core.Clues
{
    ...
    // 구현하지 않는다.
    public sealed class MemoryRoomClueTracker : IMemoryRoomClueTracker
    {
        private readonly Dictionary<ClueId, ClueDefinition> _definitionsById;
        ...
        public MemoryRoomClueTracker(IReadOnlyList<ClueDefinition> clueDefinitions)
        {
            ...
            _definitionsById = new Dictionary<ClueId, ClueDefinition>(clueDefinitions.Count);
